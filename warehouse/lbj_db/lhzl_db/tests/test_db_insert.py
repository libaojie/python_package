...
from lbj_db.df.df_db_tool import DFDBTool
...
def test():
    ...
    # page_code = 'code'
    # page_key  = 'key'
    # dict_tbl_name = 'lbjmr.mr_dict'
    # db = create_engine("oracle://lbjca:D_Matca#2018@192.168.160.231:1521/orcl")
...
def test_insert():
    ...
    :return:
    """
    db = create_engine("oracle://lbjibm:D_Matibm#2018@192.168.160.231:1521/orcl")
    DBEngineTool.init_db(db)
